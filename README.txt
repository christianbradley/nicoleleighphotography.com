...
INSTALL
1. Upload the Landscape child theme folder via FTP to your wp-content/themes/ directory.  (the Genesis parent theme needs to be in the wp-content/themes/ directory as well)
2. Go to your WordPress dashboard and select Appearance.
3. Activate the Landscape theme.
...
Footer Gallery - This is the gallery of the footer section.
